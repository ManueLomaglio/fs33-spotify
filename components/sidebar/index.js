...
$buttonPlus.addEventListener("click", function (event) {
  const $existingTooltip = document.querySelector(".js-button-new-playlist");
  ...
  $buttonPlus.insertAdjacentHTML(
    ...
    `<div class="main__button-new-playlist__container js-button-new-playlist">
...
function handleOutsideClick(event) {
  const $tooltip = document.querySelector(".js-button-new-playlist");
  ...
  if (
    !event.target.closest(".js-button-new-playlist") &&
